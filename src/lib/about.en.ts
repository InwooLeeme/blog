...
export const projects: Project[] = [
  {
    ...
    links: [
      ...
      { label: "Build log", href: "/blog/mcp_assistant", type: "post" },
    ],
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Rebuild log", href: "/blog/nasdaq_pattern_chart", type: "post" },
    ],
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Performance write-up", href: "/blog/lighthouse_mobile_performance", type: "post" },
      { label: "Debugging write-up", href: "/blog/nextjs_dynamic_params_decoding", type: "post" },
    ],
